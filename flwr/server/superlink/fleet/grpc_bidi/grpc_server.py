...
1) Line 41: Changed the max_concurrent_workers default value from 1000 to 10000 (Maximum number of clients).
2) Line 43: Changed the keepalive_time_ms default value from 210000 to 7200000 (gRPC keepalive time).
"""
