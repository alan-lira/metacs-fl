...
5) Lines 408-415: Addition that allows to get the 'client_id' of 'fit' clients.
6) Line 435: Used the '_time_function_execution' function to measure the elapsed time of 'evaluate_client' function.
7) Lines 477-484: Addition that allows to get the 'client_id' of 'evaluate' clients.
"""
...
def _handle_finished_future_after_fit(
    ...
    result[1].metrics.update({"client_id": client_id})
    _, res = result
